  ...
  return (
    <div className="w-full h-screen flex flex-col gap-10 items-center justify-center max-h-screen overflow-y-auto">
      ...
      <form
        ...
        className="md:w-[30vw] w-full py-5 pb-7 px-10 bg-black rounded-lg shadow-xl flex flex-col gap-5"
      >
        ...
        <div>
          ...
          <button
            type="submit"
            className="w-full text-black bg-white hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-800 text-lg rounded-lg px-5 py-2.5 mt-5 text-center"
          >
            Make Suggestion
          </button>
        </div>
