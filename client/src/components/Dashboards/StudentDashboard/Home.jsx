...
const List = () => {
  const [invoiceList, setInvoiceList] = useState([
    {
      title: "InnoVision",
      date: "20-11-2024",
      amount: "Technical Fest",
      status: "pending",
    },
    {
      title: "NitrUtsav",
      date: "11-3-2025",
      amount: "Cultural Fest",
      status: "pending",
    },
    {
      title: "Vriddhi",
  ...
  return (
    <div className="w-full max-w-md p-4 rounded-lg shadow sm:p-8 bg-black drop-shadow-xl overflow-y-auto max-h-70">
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center flex-col gap-5 max-h-screen overflow-y-auto pt-64 lg:pt-0 md:pt-64 sm:pt-96">
      ...
      <div className="flex gap-5 w-full justify-center flex-wrap">
        <List />
        <div className="flex flex-col items-center bg-black rounded-xl shadow-xl p-5">
          <span className="text-white text-xl">Your Attendance</span>
          <Doughnut
            datasetIdKey="id"
            data={{
              labels,
