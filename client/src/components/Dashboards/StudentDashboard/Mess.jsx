  ...
  return (
    ...
    <div className="w-full h-screen gap-10 flex flex-col items-center justify-center max-h-screen overflow-y-auto pt-[500px] sm:pt-96 md:pt-96 lg:pt-40">
      ...
      <div className="w-full gap-10 flex items-center justify-center flex-wrap">
        ...
        <div className="w-full sm:w-80 max-w-md max-h-60 p-4 border rounded-lg shadow sm:p-8 bg-black border-neutral-900 drop-shadow-xl overflow-y-auto">
      ...
      <form
        ...
        className="bg-black py-5 px-10 rounded-lg shadow-xl w-full sm:w-auto"
      >
        ...
        <button
          type="submit"
          className="w-full text-white bg-gray-900 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-800 text-xl rounded-lg px-5 py-2.5 mt-5 text-center"
        >
          {loading ? (
