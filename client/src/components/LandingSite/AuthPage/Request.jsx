    ...
    <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700">
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
        <h1 className="text-xl font-bold leading-tight tracking-tight md:text-2xl text-white">
          Request account from SAC Authorities
        </h1>
        <form className="space-y-4 md:space-y-6" onSubmit={register}>
          <Input field={cms} />
          <button
            type="submit"
            className="w-full text-white hover:bg-gray-700 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-black focus:ring-blue-800"
          >
            Request
          </button>
